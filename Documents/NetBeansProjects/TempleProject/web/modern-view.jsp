<%-- 
    Document   : modernview
    Created on : Jun 15, 2017, 12:22:36 AM
    Author     : srijana
--%>
...
<jsp:include page="modern-header.jsp"></jsp:include>
    <jsp:include page="modern-nav.jsp"></jsp:include>
...
<!--                <h3>Project One</h3>
 ...
 <a class="btn btn-primary" href="${pageContext.request.contextPath}/modern">View Project</i></a>
       ...
       <jsp:include page="modern-footer.jsp"></jsp:include>
